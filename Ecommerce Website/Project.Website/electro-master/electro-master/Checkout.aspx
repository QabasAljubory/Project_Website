<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="Project.Website.electro_master.electro_master.Checkout" %>
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							<div class="order-products">
								<div class="order-col">
									<div>
                                        <asp:Label ID="Label6" runat="server" Text='<%# Eval("PrudectName") %>'></asp:Label></div>
									<div><asp:Label ID="Label7" runat="server" Text='<%# Eval("Price") %>'></asp:Label></div>
								</div>
